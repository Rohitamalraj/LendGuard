...
export class LendGuard {
    ...
    async initializeProtocol(_params) {
        if (this.program) {
    ...
    async initializeRiskState(params) {
    ...
    async verifyCustodyProof(params) {
        this.assertRequired("vaultId", params.vaultId);
    ...
    async updateBackingState(params) {
        this.assertRequired("vaultId", params.vaultId);
